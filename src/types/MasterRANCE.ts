...
export interface MasterRANCEInterface extends utils.Interface {
  contractName: "MasterRANCE";
  functions: {
...
export interface MasterRANCE extends BaseContract {
  contractName: "MasterRANCE";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MasterRANCEInterface;
